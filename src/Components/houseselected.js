            ...
            <div className='col-md-8 p-3 '>
                ...
                <div className='d-flex'><p className=''>Completely employee-owned,we're driven with a passion</p></div><br/><br/>
                    <div className='d-flex flex-wrap ' style={{marginLeft:-20}}>
                        ...
                        <PiCalendarCheck className='icon5'/>
                               <p className='' style={{fontSize:11,fontWeight:'bold'}} align='center'>LOWER MONTHLY PAYMENT (REFINANCE)</p>
                        </div>
                        <div className='paper6'>
                        <BiHomeAlt2 className='icon6'/>
                            <p className='pt-1'style={{fontSize:10,fontWeight:'bold'}} align='center'>GET CASH FORMEQUITY (CASH OUT REFINANCE)</p>
                        </div>
                        <Link to='/typesofhome'  className='text-decoration-none'><div className='paper7'>
                            <AiOutlineHome className='icon7 '/>
                            <p className='pt-1'style={{fontSize:11,fontWeight:'bold'}} align='center'>NEW HOME</p>
                        </div></Link>
                    </div><br/>
                    <div className='p-3 pt-4 d-flex' style={{marginRight:10}}>
                        ...
                        <button className='btn btn-primary ms-4' style={{borderRadius:20,width:100}}><Link to='/typesofhome' className='text-white text-decoration-none' >Next</Link> <HiArrowLongRight/></button>
                    </div><br/>
                </div>
            </div>
        </div>
