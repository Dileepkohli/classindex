      ...
      <div className='row'>
        ...
        <div className='col-md-8 container p-5 mt-3'>
            ...
            <Paper className='p-4 mt-5' >
                <div className='d-flex'><BiSolidHotel style={{fontSize:24}}/> <p className='ms-2'> Where are you going to ?</p></div>
                <FormControl variant="standard" fullWidth sx={{ m: 1,}}>
                    ...
                    <div className='p-3 pt-4 d-flex' style={{marginRight:50}}>
                        ...
                        <button className='btn btn-primary ms-4' style={{borderRadius:20,width:100}}><Link to='/hotelselected' className='text-white text-decoration-none'>Next</Link> <HiArrowLongRight/></button>
                    </div><br/><br/><br/><br/><br/>
            </div>
        </div>
      </div>
